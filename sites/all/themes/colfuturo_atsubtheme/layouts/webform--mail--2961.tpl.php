 ...
 */
?>
<?php print ($email['html'] ? '<p>' : '') . t('Submitted on %date AQUI ENTRO'). ($email['html'] ? '</p>' : ''); ?>
<div id="mimemail-header">
  <img src="../images/publicaciones/neiva-gracias.png" alt="Logo Goes Here" id="logo" />
</div>
<div id="mimemail-header-2">
  <img src="http://apps.colfuturo.org/boletines/2018/Comunicaciones/07_Charlas2019_NeivaGracias.html" alt="Logo Goes Here 2" id="logo2" />
</div>
<?php if ($user->uid): ?>
